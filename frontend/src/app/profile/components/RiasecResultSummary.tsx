...
export function RiasecResultSummary({ profile }: { profile: DigitalCompetencyProfile }) {
  ...
  return (
    <section className="animate-[slideUp_0.8s_ease-out_forwards] opacity-0 mb-12" style={{ animationFillMode: 'forwards' }}>
      <div className="glass-panel border border-white/20 rounded-[2.5rem] p-8 md:p-12 bg-black/40 backdrop-blur-2xl relative overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.5)]">
